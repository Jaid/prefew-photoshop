 ...
 * @example
 * import prefewPhotoshop from "prefew-photoshop"
 * let result = prefewPhotoshop(["a", "b"])
 * result = {a: null, b: null}
 * @example
 * import prefewPhotoshop from "prefew-photoshop"
 * let result = prefewPhotoshop(["a", "b"], "value")
 * result = {a: "value", b: "value"}
 * @example
 * import prefewPhotoshop from "prefew-photoshop"
 * let result = prefewPhotoshop(["a", "b"], (key, index) => `value for ${key} #${index + 1}`)
 ...
 * import {parallel} from "prefew-photoshop"
